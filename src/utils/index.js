...
export const CITIES = [
    { value: 1, label: "L'Aquila", short: "AQ", region: 1 },
    { value: 2, label: "Chieti'Aquila", short: "CH", region: 1 },
    { value: 3, label: "Pescara", short: "PE", region: 1 },
    { value: 4, label: "Teramo", short: "TE", region: 1 },
    { value: 5, label: "Matera", short: "MT", region: 2 },
    { value: 6, label: "Potenza", short: "PZ", region: 2 },
    { value: 7, label: "Catanzaro", short: "CZ", region: 3 },
    { value: 8, label: "Cosenza", short: "CS", region: 3 },
    { value: 9, label: "Crotone", short: "KR", region: 3 },
    { value: 10, label: "Reggio-Calabria", short: "RC", region: 3 },
    { value: 11, label: "Vibo-Valentia", short: "VV", region: 3 },
    { value: 12, label: "Avellino", short: "AV", region: 4 },
    { value: 13, label: "Benevento", short: "BN", region: 4 },
    { value: 14, label: "Caserta", short: "CE", region: 4 },
    { value: 15, label: "Napoli", short: "NA", region: 4 },
    { value: 16, label: "Salerno", short: "SA", region: 4 },
    { value: 17, label: "Bologna", short: "BO", region: 5 },
    { value: 18, label: "Ferrara", short: "FE", region: 5 },
    { value: 19, label: "Forli-Cesena", short: "FC", region: 5 },
    { value: 20, label: "Modena", short: "MO", region: 5 },
    { value: 21, label: "Parma", short: "PR", region: 5 },
    { value: 22, label: "Piacenza", short: "PC", region: 5 },
    { value: 23, label: "Ravenna", short: "RA", region: 5 },
    { value: 24, label: "Reggio-Emilia", short: "RE", region: 5 },
    { value: 25, label: "Rimini", short: "RN", region: 5 },
    { value: 26, label: "Gorizia", short: "GO", region: 6 },
    { value: 27, label: "Pordenone", short: "PN", region: 6 },
    { value: 28, label: "Trieste", short: "TS", region: 6 },
    { value: 29, label: "Udine", short: "UD", region: 6 },
    { value: 30, label: "Frosinone", short: "FR", region: 7 },
    { value: 31, label: "Latina", short: "LT", region: 7 },
    { value: 32, label: "Rieti", short: "RI", region: 7 },
    { value: 33, label: "Roma", short: "Roma", region: 7 },
    { value: 34, label: "Viterbo", short: "VT", region: 7 },
    { value: 35, label: "Genova", short: "GE", region: 8 },
    { value: 36, label: "Imperia", short: "IM", region: 8 },
    { value: 37, label: "La-Spezia", short: "SP", region: 8 },
    { value: 38, label: "Savona", short: "SV", region: 8 },
    { value: 39, label: "Bergamo", short: "BG", region: 9 },
    { value: 40, label: "Brescia", short: "BS", region: 9 },
    { value: 41, label: "Como", short: "CO", region: 9 },
    { value: 42, label: "Cremona", short: "CR", region: 9 },
    { value: 43, label: "Lecco", short: "LC", region: 9 },
    { value: 44, label: "Lodi", short: "LO", region: 9 },
    { value: 45, label: "Mantova", short: "MN", region: 9 },
    { value: 46, label: "Milano", short: "MI", region: 9 },
    { value: 47, label: "Monza-Brianza", short: "MB", region: 9 },
    { value: 48, label: "Pavia", short: "PV", region: 9 },
    { value: 49, label: "Sondrio", short: "SO", region: 9 },
    { value: 50, label: "Varese", short: "VA", region: 9 },
    { value: 51, label: "Ancona", short: "AN", region: 10 },
    { value: 52, label: "Ascoli-Piceno", short: "AP", region: 10 },
    { value: 53, label: "Fermo", short: "FM", region: 10 },
    { value: 54, label: "Macerata", short: "MC", region: 10 },
    { value: 55, label: "Pesaro-Urbino", short: "PU", region: 10 },
    { value: 56, label: "Campobasso", short: "CB", region: 11 },
    { value: 57, label: "Isernia", short: "IS", region: 11 },
    { value: 58, label: "Alessandria", short: "AL", region: 12 },
    { value: 59, label: "Asti", short: "AT", region: 12 },
    { value: 60, label: "Biella", short: "BI", region: 12 },
    { value: 61, label: "Cuneo", short: "CN", region: 12 },
    { value: 62, label: "Novara", short: "NO", region: 12 },
    { value: 63, label: "Torino", short: "TO", region: 12 },
    { value: 64, label: "Verbania", short: "VB", region: 12 },
    { value: 65, label: "Vercelli", short: "VC", region: 12 },
    { value: 66, label: "Bari", short: "BA", region: 13 },
    { value: 67, label: "Barletta-Andria-Trani", short: "BT", region: 13 },
    { value: 68, label: "Brindisi", short: "BR", region: 13 },
    { value: 69, label: "Foggia", short: "FG", region: 13 },
    { value: 70, label: "Lecce", short: "LE", region: 13 },
    { value: 71, label: "Taranto", short: "TA", region: 13 },
    { value: 72, label: "Cagliari", short: "CA", region: 14 },
    { value: 73, label: "Carbonia Iglesias", short: "CI", region: 14 },
    { value: 74, label: "Medio Campidano", short: "VS", region: 14 },
    { value: 75, label: "Nuoro", short: "NU", region: 14 },
    { value: 76, label: "Ogliastra", short: "OG", region: 14 },
    { value: 77, label: "Olbia Tempio", short: "OT", region: 14 },
    { value: 78, label: "Oristano", short: "OR", region: 14 },
    { value: 79, label: "Sassari", short: "SS", region: 14 },
    { value: 80, label: "Agrigento", short: "AG", region: 15 },
    { value: 81, label: "Caltanissetta", short: "CL", region: 15 },
    { value: 82, label: "Catania", short: "CT", region: 15 },
    { value: 83, label: "Enna", short: "EN", region: 15 },
    { value: 84, label: "Messina", short: "ME", region: 15 },
    { value: 85, label: "Palermo", short: "PA", region: 15 },
    { value: 86, label: "Ragusa", short: "RG", region: 15 },
    { value: 87, label: "Siracusa", short: "SR", region: 15 },
    { value: 88, label: "Trapani", short: "TP", region: 15 },
    { value: 89, label: "Arezzo", short: "AR", region: 16 },
    { value: 90, label: "Firenze", short: "FI", region: 16 },
    { value: 91, label: "Grosseto", short: "GR", region: 16 },
    { value: 92, label: "Livorno", short: "LI", region: 16 },
    { value: 93, label: "Lucca", short: "LU", region: 16 },
    { value: 94, label: "Massa-Carrara", short: "MS", region: 16 },
    { value: 95, label: "Pisa", short: "PI", region: 16 },
    { value: 96, label: "Pistoia", short: "PT", region: 16 },
    { value: 97, label: "Prato", short: "PO", region: 16 },
    { value: 98, label: "Siena", short: "SI", region: 16 },
    { value: 99, label: "Bolzano", short: "BZ", region: 17 },
    { value: 100, label: "Trento", short: "TN", region: 17 },
    { value: 101, label: "Perugia", short: "PG", region: 18 },
    { value: 102, label: "Terni", short: "TR", region: 18 },
    { value: 103, label: "Aosta", short: "AO", region: 19 },
    { value: 104, label: "Belluno", short: "BL", region: 20 },
    { value: 105, label: "Padova", short: "PD", region: 20 },
    { value: 106, label: "Rovigo", short: "RO", region: 20 },
    { value: 107, label: "Treviso", short: "TV", region: 20 },
    { value: 108, label: "Venezia", short: "VE", region: 20 },
    { value: 109, label: "Verona", short: "VR", region: 20 },
    { value: 110, label: "Vicenza", short: "VI", region: 20 },
];
