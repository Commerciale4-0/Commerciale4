...
export const CITIES = [
    { value: 1, label: "L'Aquila", region: 1 },
    { value: 2, label: "Chieti'Aquila", region: 1 },
    ...
    { value: 18, label: "Ferrara", region: 5 },
    { value: 19, label: "Forli-Cesena", region: 5 },
    { value: 20, label: "Modena", region: 5 },
    { value: 21, label: "Parma", region: 5 },
    { value: 22, label: "Piacenza", region: 5 },
    { value: 23, label: "Ravenna", region: 5 },
    { value: 24, label: "Reggio-Emilia", region: 5 },
    { value: 25, label: "Rimini", region: 5 },
    { value: 26, label: "Gorizia", region: 6 },
    { value: 27, label: "Pordenone", region: 6 },
    { value: 28, label: "Trieste", region: 6 },
    { value: 29, label: "Udine", region: 6 },
    { value: 30, label: "Frosinone", region: 7 },
    { value: 31, label: "Latina", region: 7 },
    { value: 32, label: "Rieti", region: 7 },
    { value: 33, label: "Roma", region: 7 },
    { value: 34, label: "Viterbo", region: 7 },
    { value: 35, label: "Genova", region: 8 },
    { value: 36, label: "Imperia", region: 8 },
    { value: 37, label: "La-Spezia", region: 8 },
    { value: 38, label: "Savona", region: 8 },
    { value: 39, label: "Bergamo", region: 9 },
    { value: 40, label: "Brescia", region: 9 },
    { value: 41, label: "Como", region: 9 },
    { value: 42, label: "Cremona", region: 9 },
    { value: 43, label: "Lecco", region: 9 },
    { value: 44, label: "Lodi", region: 9 },
    { value: 45, label: "Mantova", region: 9 },
    { value: 46, label: "Milano", region: 9 },
    { value: 47, label: "Monza-Brianza", region: 9 },
    { value: 48, label: "Pavia", region: 9 },
    { value: 49, label: "Sondrio", region: 9 },
    { value: 50, label: "Varese", region: 9 },
    { value: 51, label: "Ancona", region: 10 },
    { value: 52, label: "Ascoli-Piceno", region: 10 },
    { value: 53, label: "Fermo", region: 10 },
    { value: 54, label: "Macerata", region: 10 },
    { value: 55, label: "Pesaro-Urbino", region: 10 },
    { value: 56, label: "Campobasso", region: 11 },
    { value: 57, label: "Isernia", region: 11 },
    { value: 58, label: "Alessandria", region: 12 },
    { value: 59, label: "Asti", region: 12 },
    { value: 60, label: "Biella", region: 12 },
    { value: 61, label: "Cuneo", region: 12 },
    { value: 62, label: "Novara", region: 12 },
    { value: 63, label: "Torino", region: 12 },
    { value: 64, label: "Verbania", region: 12 },
    { value: 65, label: "Vercelli", region: 12 },
    { value: 66, label: "Bari", region: 13 },
    { value: 67, label: "Barletta-Andria-Trani", region: 13 },
    { value: 68, label: "Brindisi", region: 13 },
    { value: 69, label: "Foggia", region: 13 },
    { value: 70, label: "Lecce", region: 13 },
    { value: 71, label: "Taranto", region: 13 },
    { value: 72, label: "Cagliari", region: 14 },
    { value: 73, label: "Carbonia Iglesias", region: 14 },
    { value: 74, label: "Medio Campidano", region: 14 },
    { value: 75, label: "Nuoro", region: 14 },
    { value: 76, label: "Ogliastra", region: 14 },
    { value: 77, label: "Olbia Tempio", region: 14 },
    { value: 78, label: "Oristano", region: 14 },
    { value: 79, label: "Sassari", region: 14 },
    { value: 80, label: "Agrigento", region: 15 },
    { value: 81, label: "Caltanissetta", region: 15 },
    { value: 82, label: "Catania", region: 15 },
    { value: 83, label: "Enna", region: 15 },
    { value: 84, label: "Messina", region: 15 },
    { value: 85, label: "Palermo", region: 15 },
    { value: 86, label: "Ragusa", region: 15 },
    { value: 87, label: "Siracusa", region: 15 },
    { value: 88, label: "Trapani", region: 15 },
    { value: 89, label: "Arezzo", region: 16 },
    { value: 90, label: "Firenze", region: 16 },
    { value: 91, label: "Grosseto", region: 16 },
    { value: 92, label: "Livorno", region: 16 },
    { value: 93, label: "Lucca", region: 16 },
    { value: 94, label: "Massa-Carrara", region: 16 },
    { value: 95, label: "Pisa", region: 16 },
    { value: 96, label: "Pistoia", region: 16 },
    { value: 97, label: "Prato", region: 16 },
    { value: 98, label: "Siena", region: 16 },
    { value: 99, label: "Bolzano", region: 17 },
    { value: 100, label: "Trento", region: 17 },
    { value: 101, label: "Perugia", region: 18 },
    { value: 102, label: "Terni", region: 18 },
    { value: 103, label: "Aosta", region: 19 },
    { value: 104, label: "Belluno", region: 20 },
    { value: 105, label: "Padova", region: 20 },
    { value: 106, label: "Rovigo", region: 20 },
    { value: 107, label: "Treviso", region: 20 },
    { value: 108, label: "Venezia", region: 20 },
    { value: 109, label: "Verona", region: 20 },
    { value: 110, label: "Vicenza", region: 20 },
];
