	...
	render() {
		return (
			<div className="forgot-password">
				...
				<div className="text">When you fill in your registered email address, you will be sent instructions on how to reset your password.</div>
				<div className="my-3 d-flex justify-content-center">
					<input type="text" name="email" placeholder="Email" ref={this.refEmail} />
				</div>
				<div className="d-flex justify-content-center">
					<button onClick={this.handleClickDone.bind(this)}>Send Email</button>
				</div>
			</div>
		);
	}
